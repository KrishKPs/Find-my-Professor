...
const mockProfiles = [
  { id: 1, name: 'Dr. Jane Smith', title: 'Professor', college: 'Stanford University', category: 'Professor', expertise: 'Computer Science', image: '/placeholder.svg?height=100&width=100' },
  { id: 2, name: 'John Doe', title: 'Academic Advisor', college: 'MIT', category: 'Academic Advisor', expertise: 'Engineering', image: '/placeholder.svg?height=100&width=100' },
  { id: 3, name: 'Alice Johnson', title: 'Consultant', college: 'Harvard Business School', category: 'Consultant', expertise: 'Business Strategy', image: '/placeholder.svg?height=100&width=100' },
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {selectedProfile && (
          <div className="fixed inset-y-0 right-0 w-full sm:w-96 bg-white shadow-2xl p-8 overflow-y-auto transition-transform transform translate-x-0">
            ...
            <img src={selectedProfile.image} alt={selectedProfile.name} className="w-32 h-32 rounded-full mx-auto mb-6" />
