...
const ProfessorDetailForm = () => {
  ...
  const handleAddOfficeHour = () => {
    setFormData((prev) => ({
      ...prev,
      office_hours: [...prev.office_hours, { day: '', start_time: '', end_time: '' }],
    }));
  };
                ...
                <div className="flex items-center space-x-4 w-full">
                  ...
                  <div className="flex space-x-4 w-full">
                    <Input
                      ...
                      onChange={(e) =>
                        handleOfficeHourChange(index, 'start_time', e.target.value)
                      }
                      required
                    />
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleOfficeHourChange(index, 'end_time', e.target.value)
                      }
                      required
                    />
                  </div>
