...
export default function Homepage() {
    ...
    useEffect(() => {
        if (searchClicked) {
            // Animate heading, search bar, and category filters to move up
            gsap.to(headingRef.current, {
                y: -50, // Reduced to keep it visible
                opacity: 1,
                duration: 1,
                ease: "power3.out"
            });
            gsap.to([searchBarRef.current, categoryRef.current], {
                y: -50,
                opacity: 1,
                duration: 1,
                ease: "power3.out",
            ...
            // Stagger the cards loading effect after the heading, search bar, and category animation
            gsap.from(cardsRef.current, {
                ...
                stagger: 0.1,
                ease: "power3.out",
                delay: 1.2  // Wait for the heading, search bar, and category to finish moving up
            });
        }
    }, [searchClicked]);
    ...
    return (
        <div className="flex flex-col items-center min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-700 text-center px-4">
            {/* Heading */}
            <div ref={headingRef} className="mt-10 mb-6">
            ...
            {/* Category Filters */}
            <div ref={categoryRef} className="flex flex-wrap gap-2 mt-4 mb-8">
